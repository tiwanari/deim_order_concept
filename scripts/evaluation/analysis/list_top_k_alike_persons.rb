...
if ARGV.length < require_params
    ...
    puts "Usage: #{__FILE__} user_infos_csv path_to_persons_data top_k"
    puts "\t- path_to_persons_data should be in #{QUERIES_FOLDER})"
    puts "e.g. #{__FILE__} queries9/gold/human/all/analysis/infos.csv queries9/gold/human/all 5"
    exit 1
end
...
puts_graphvis_header("alike_top_#{top_k}")
